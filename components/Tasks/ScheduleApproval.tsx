...
export function ScheduleApproval1() {
  return (
    <div className="w-full h-[45vh] bg-white border border-[#D5D7D8] flex flex-col rounded-[10px] p-6 gap-5">
      <h1 className="font-monts font-bold text-lg text-darkerGray underline">
        Schedule Approval
      </h1>
      <div className="flex flex-col gap-1">
        <p className="font-monts text-sm text-darkerGray font-regular">
          You requested to schedule the inspection date to be on:{" "}
          <span className="font-bold">Thursday, 6/22/2023</span>
        </p>
        <p className="font-monts text-sm text-darkerGray font-regular">
          Please wait for the RO to respond. Feel free to contact them for
          follow-ups.
        </p>
      </div>
    </div>
...
export function ScheduleApproval2() {
  return (
    <div className="h-fit lg:h-[45vh] bg-white border border-[#D5D7D8] flex flex-col rounded-[10px] p-6 gap-5">
      ...
      <div className="flex flex-col gap-1">
        <p className="font-monts text-sm text-darkerGray font-regular">
          RO Makati counter-requested the inspection date to be on:{" "}
